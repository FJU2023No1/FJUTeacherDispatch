...
public class SpecialTabDefault extends BaseTabItem {
    ...
    public SpecialTabDefault(Context context) {
        this(context, null);
    }

    public SpecialTabDefault(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpecialTabDefault(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.fju_td_app_layout_special_tab_default, this, true);
